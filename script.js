...
snakeHeadImg.src = "snake_head.png"; // your face image
...
// Keyboard control
let KEY = { ArrowUp: false, ArrowRight: false, ArrowDown: false, ArrowLeft: false,
  ...
  listen() {
    ...
    addEventListener("keyup", e => { if (e.key in this) this[e.key] = false; });
  }
};
KEY.listen();
...
let lastTime = 0;
let accumulator = 0;
let snakeSpeed = 50; // moves per second
let step = 1000 / snakeSpeed; // ms per move
...
function loop(timestamp = 0) {
  ...
  // update snake logic only at fixed rate
